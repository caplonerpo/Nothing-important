...
Default = {
			TextFont = "Gotham",
			TextColor = Color3.fromRGB(45, 45, 45),

			Background = Color3.fromRGB(255, 255, 255),
			Topbar = Color3.fromRGB(255, 244, 238),
			Shadow = Color3.fromRGB(245, 236, 230),

			NotificationBackground = Color3.fromRGB(255, 250, 247),
			NotificationActionsBackground = Color3.fromRGB(255, 240, 230),

			TabBackground = Color3.fromRGB(255, 245, 240),
			TabStroke = Color3.fromRGB(235, 210, 195),
			TabBackgroundSelected = Color3.fromRGB(255, 210, 170),
			TabTextColor = Color3.fromRGB(60, 60, 60),
			SelectedTabTextColor = Color3.fromRGB(40, 40, 40),

			ElementBackground = Color3.fromRGB(255, 247, 243),
			ElementBackgroundHover = Color3.fromRGB(255, 235, 220),
			SecondaryElementBackground = Color3.fromRGB(255, 244, 238), -- For labels and paragraphs
			ElementStroke = Color3.fromRGB(235, 210, 195),
			SecondaryElementStroke = Color3.fromRGB(225, 195, 175), -- For labels and paragraphs

			SliderBackground = Color3.fromRGB(255, 210, 160),
			SliderProgress = Color3.fromRGB(255, 175, 115),
			SliderStroke = Color3.fromRGB(255, 155, 95),

			ToggleBackground = Color3.fromRGB(255, 244, 238),
			ToggleEnabled = Color3.fromRGB(255, 175, 115),
			ToggleDisabled = Color3.fromRGB(200, 200, 200),
			ToggleEnabledStroke = Color3.fromRGB(255, 150, 80),
			ToggleDisabledStroke = Color3.fromRGB(140, 140, 140),
			ToggleEnabledOuterStroke = Color3.fromRGB(255, 140, 70),
			ToggleDisabledOuterStroke = Color3.fromRGB(165, 165, 165),

			InputBackground = Color3.fromRGB(255, 247, 243),
			InputStroke = Color3.fromRGB(235, 210, 195),
			PlaceholderColor = Color3.fromRGB(160, 140, 130)
		},
},
		Light = {
Light = {
	...
	Background = Color3.fromRGB(255, 255, 255),
	Topbar = Color3.fromRGB(253, 245, 240),
	Shadow = Color3.fromRGB(246, 238, 233),

	NotificationBackground = Color3.fromRGB(255, 250, 247),
	NotificationActionsBackground = Color3.fromRGB(255, 240, 230),

	TabBackground = Color3.fromRGB(255, 245, 240),
	TabStroke = Color3.fromRGB(220, 190, 165),
	TabBackgroundSelected = Color3.fromRGB(255, 200, 150),
	TabTextColor = Color3.fromRGB(60, 60, 60),
	SelectedTabTextColor = Color3.fromRGB(40, 40, 40),

	ElementBackground = Color3.fromRGB(250, 245, 240),
	ElementBackgroundHover = Color3.fromRGB(255, 235, 220),
	SecondaryElementBackground = Color3.fromRGB(240, 230, 225), -- For labels and paragraphs
	ElementStroke = Color3.fromRGB(225, 200, 170),
	SecondaryElementStroke = Color3.fromRGB(200, 180, 160),  --For labels and paragraphs
	...
	ToggleEnabledStroke = Color3.fromRGB(255, 160, 90),
	ToggleDisabledStroke = Color3.fromRGB(140, 140, 140),
	ToggleEnabledOuterStroke = Color3.fromRGB(240, 140, 80),
	ToggleDisabledOuterStroke = Color3.fromRGB(170, 140, 140),

	InputBackground = Color3.fromRGB(255, 247, 243),
	InputStroke = Color3.fromRGB(230, 200, 175),
	PlaceholderColor = Color3.fromRGB(150, 130, 120)
},
}
}
...
local Window = Rayfield:CreateWindow({Name="Ink Games",Theme="Default"})
local RemoterTab = Window:CreateTab("Remoter (admin panels)")

local Filters={"Scripts","LocalScripts","ModuleScripts","RemoteEvents"}
local SelectedFilters={}

RemoterTab:CreateDropdown({
Name="Filter",
Options=Filters,
Multiple=true,
Callback=function(v)
...
RemoterTab:CreateInput({
Name="Search",
PlaceholderText="Type name",
Callback=function(text)
local results={}
local function match(obj)
local n=string.lower(obj.Name)
local t=string.lower(text)
return string.find(n,t,1,true)
end
...
local ok=false
if #SelectedFilters==0 then ok=true else
for _,f in ipairs(SelectedFilters) do
if (f=="Scripts" and class=="Script")
or (f=="LocalScripts" and class=="LocalScript")
or (f=="ModuleScripts" and class=="ModuleScript")
or (f=="RemoteEvents" and class=="RemoteEvent") then
ok=true
break
end
end
end
if ok then table.insert(results,v:GetFullName()) end
end
scan(v)
end
end
